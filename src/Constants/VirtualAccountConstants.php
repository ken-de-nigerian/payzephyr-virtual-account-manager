...
final class VirtualAccountConstants
{
     ...
     */
    public const int WEBHOOK_TIMESTAMP_TOLERANCE_SECONDS = 300;

    /**
     * Default health check cache TTL in seconds (5 minutes).
     */
    public const int HEALTH_CHECK_CACHE_TTL_SECONDS = 300;

    /**
     * Maximum string length before token pattern checking in log sanitization.
     */
    public const int MAX_STRING_LENGTH_FOR_TOKEN_CHECK = 20;
     ...
     */
    public const int METADATA_MAX_STRING_LENGTH = 10000;

    /**
     * Maximum array size for metadata arrays.
     */
    public const int METADATA_MAX_ARRAY_SIZE = 100;
     ...
     */
    public const int DEFAULT_RETRY_ATTEMPTS = 2;
